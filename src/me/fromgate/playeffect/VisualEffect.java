...
public enum VisualEffect  {
    ...
    SUSPEND(EffectParticles.class,"effectname:suspend num:5",5,"num,speed,offset,offsetX,offsetY,offsetZ"),
    DEPTHSUSPEND(EffectParticles.class,"effectname:depthSsuspend num:5",5,"num,speed,offset,offsetX,offsetY,offsetZ"),
    TOWNAURA(EffectParticles.class,"effectname:townaura num:5",5,"num,speed,offset,offsetX,offsetY,offsetZ"),
